...
<!-- navbar --> 
      ...
      <img src="canvas6.jpeg" width="200px" height="100px" alt="no-image"/>
            ...
            <div class="row">
                ...
                ?>
                    <tr>
						...
						<td><a href="stdentDetails.php?USN= <?php echo $rows['USN'] ;?>"> <button type="button" class="btn">View Details</button></a></td> 
